...
def main():
    ...
    data = pd.DataFrame([[pclass_radio + 1, sex_radio, age_slider, sibsp_slider, parch_slider, fare_slider]],
    ...
    with prediction:
        ...
        st.subheader("Pewność predykcji {0:.2f} %".format(s_confidence[0][int(survival[0])] * 100))
